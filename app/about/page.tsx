    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="prose prose-lg max-w-none mb-12">
        ...
        <div className="bg-primary-50 border-l-4 border-primary-600 p-6 mb-6">
          <p className="text-gray-700 mb-4">
            <strong>Important:</strong> Ovux Biotech Solutions is a global sourcing company. We work
            within the bounds of applicable laws and regulations, and we encourage our clients 
